...
function showFinalModal() {
  ...
  finalModalContent.innerHTML +=
    '<div class="table-wrapper">' + generateGameScoreTable(params.progress, progressCollumnNames) + '</div>';
}
...
function singleWinMsg(playerChoice, computerChoice, wonLostMsg) {
  return (
    params.playerName +
    params.youPlayedMsg +
    wrapWithSpan(playerChoice) +
    ' ' +
    params.computerName +
    params.computerPlayedMsg +
    wrapWithSpan(computerChoice) +
    '<br>' +
    wonLostMsg
  );
}
...
function playerMove(playerChoice) {
  ...
  if (playerChoice === computerChoice) {
    ...
    (playerChoice === params.moves.rock && computerChoice === params.moves.paper) ||
    (playerChoice === params.moves.scissors && computerChoice === params.moves.rock) ||
    (playerChoice === params.moves.paper && computerChoice === params.moves.scissors)
  ) {
